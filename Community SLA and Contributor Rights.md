...
This document sets a clear standard for how open source projects treat contributors.

It has two parts:

- Contributor Bill of Rights  
- Project Service Level Agreement (SLA) for community interactions  
...
This Community SLA covers how maintainers and project teams handle:

- Issues  
- Pull requests  
- Discussions and support questions  
- Code of Conduct and safety reports  
- Credit and recognition  
- Project changes that affect contributors  

It applies to all contributors, including code, docs, translations, design, triage, and community work.
...
## 3. Contributor Bill of Rights

Contributors to this project have the right to:
...
2. **Timely response to issues and pull requests**  
   - A first human response within the time frames defined in the SLA below.  
...
6. **Attribution and credit**  
   - Their work not copied into other branches or products without credit.  
...
## 4. Project SLA for community interactions

The numbers below are defaults. Projects can adjust them, but they should publish their actual targets.
...
- Update the README to set honest expectations.
...
### 4.4 Code of Conduct and safety reports
...
- A clear statement of whether the report is:
...
To claim this SLA, project maintainers commit to:

1. **Publish realistic response targets**  
   - For issues, PRs, and safety reports.  
   - Update them if the team shrinks or grows.

2. **Keep contribution docs current**  
   - Explain how to propose changes.  
   - Call out areas that are stable, high risk, or unlikely to change.

3. **Label work clearly**  
   - Use labels like `good first issue`, `help wanted`, `blocked`, `out of scope`.  
   - Close or reclassify stale items rather than let them rot.

4. **Respect contributor boundaries**  
   - No pressure to volunteer for more than a person is comfortable with.  
   - No punishment for saying no.

5. **Recognize contributions**  
   - Credit in changelogs, release notes, or a CONTRIBUTORS file.  
   - Optionally, shout outs in blog posts or social channels, with consent.

6. **Communicate major changes early**  
   - Roadmap changes that will invalidate existing contributions.  
   - Plans to archive, sunset, or fork the project.
...
3. **Do reasonable homework before filing**  
   ...
   - Provide logs, environment, and steps to reproduce where needed.
...
To keep this honest, projects can self classify:

### Level 1: Minimum

- You adopt the Contributor Bill of Rights as written.  
- You publish your expected response times for issues and PRs.  
- You have a Code of Conduct with a visible contact method.

### Level 2: Strong

Everything in Level 1, plus:

- You actively triage issues and PRs at least once per week.  
- You publish release notes that credit contributors.  
- You post periodic updates on project health and maintenance status.

### Level 3: Gold

Everything in Strong, plus:

- You have a small contributor program or recognition path.  
- You use tags or labels to invite new contributors in a structured way.  
- You collect feedback from contributors at least once a year and act on it.

Projects should not claim a higher level than they actually meet.

---

## 8. How to adopt this SLA

1. Copy this file into your repo as `COMMUNITY-SLA.md`.  
2. Update the response timelines and labels to match your reality.  
3. Link to it from your `README` and `CONTRIBUTING` docs.  
4. Optional, add a short badge or note like:  
   - “This project follows the Community SLA and Contributor Rights standard.”

If you cannot meet parts of this SLA, say so directly in the document. Honesty beats pretend alignment.
